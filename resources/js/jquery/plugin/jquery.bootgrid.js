...
;(function ($, window, undefined)
{
    ...
    */
    ...
    Grid.prototype.remove = function(rowIds)
    {
        if (this.identifier != null)
        {
            ...
            // if (this.options.ajax)
            // {
            //     console.log('remove rows ', rowIds);
    ...
    * @author nbchicong@gmail.com
    */
    Grid.prototype.searchEx = function () {
        this.searchAdvance(getCssSelector, executeSearch, loadData);
    };

    /**
    * Search when customize templates search
    * @method searchAdvance
    * @param {Function} getCssSelector
    * @param {Function} executeSearch
    * @param {Function} loadData
    * @author nbchicong@gmail.com
    */
    Grid.prototype.searchAdvance = function (getCssSelector, executeSearch, loadData) {
        this.search();
    };
