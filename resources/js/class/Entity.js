...
$(function () {
  ...
  UI.Entity = function (options) {
    ...
    this.request = null;
    this.submitType = this.submitType || Pawn.constant.JSON_STRING;
  ...
  BaseUI.extend(UI.Entity, UI.Clazz, {
    ...
    sendAjax: function (options, callback) {
      ...
      if (this.getSubmitType()==Pawn.constant.JSON) {
    ...
    create: function (callback) {
      ...
      if (!BaseUI.isEmpty(__params)) {
        this.sendAjax({
          url: this.url.create,
          method: 'POST',
          data: (this.getSubmitType()==Pawn.constant.JSON_STRING?JSON.stringify(__params):__params),
          dataType: 'JSON',
    ...
    uploadFile: function (files, callback) {
      ...
      $.ajax({
        url: Pawn.utils.getUrl('uploadFile'),
        method: 'POST',
        data: __fd,
        dataType: 'JSON',
        processData: false,
