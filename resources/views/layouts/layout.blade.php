...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="col-sm-6">
                            <div class="contactinfo">
                                <ul class="nav nav-pills">
                                    <li><a href="#"><i class="fa fa-phone"></i> {{$site->phone}}</a></li>
                                    <li><a href="#"><i class="fa fa-envelope"></i> {{$site->email}}</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="social-icons pull-right">
                                <ul class="nav navbar-nav">
                                    <li><a href="{{$site->social_fb}}"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="{{$site->social_gg}}"><i class="fa fa-google-plus"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <script src="{{asset('js/jquery/plugin/jquery.scrollUp.min.js')}}"></script>
        <script src="{{asset('js/price-range.js')}}"></script>
        <script src="{{asset('js/jquery/plugin/jquery.prettyPhoto.js')}}"></script>
